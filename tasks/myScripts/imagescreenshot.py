...
image_path = r'D:\\softwares\\jupyter_notebook\\my_code\\tasks\\myScripts\\screenshots\\image.png'

# Check if the image exists
if os.path.exists(image_path):
    # Specify the directory to save the screenshot
    save_directory = r'D:\\softwares\\jupyter_notebook\\my_code\\tasks\\myScripts\\screenshots'
    ...
    # Take a screenshot of the opened image
