...
if(isset($_POST["category"])){
	// change the database to change the list	
	$category_query = "SELECT * FROM categories where cat_id<=7";
	$run_query = mysqli_query($con,$category_query) or die(mysqli_error($con));
	echo "
		<div class='nav nav-pills nav-stacked'>
			<li class='active' align='center'><a href='#'><font size='4.5px'>Crafts</font></a></a></li>
	";
	if(mysqli_num_rows($run_query) > 0){
		while($row = mysqli_fetch_array($run_query)){
			...
			echo "
					<li><a href='#' class='category' cid='$cid'><font size='3.5px'  color='#13004d'>$cat_name</font></a></li>
			";
		}
		echo "</div>";
	}
...
if(isset($_POST["category"])){
	...
	echo "
		<div class='nav nav-pills nav-stacked'>
			<li class='active' align='center'><a href='#'><font size='4.5px'>Arts</font></a></li>
	";
	if(mysqli_num_rows($run_query) > 0){
		while($row = mysqli_fetch_array($run_query)){
			$cid = $row["cat_id"];
...
if(isset($_POST["brand"])){
	...
	echo "
		<div class='nav nav-pills nav-stacked'>
			<li class='active' align='center'><a href='#'><font size='4.5px'>Brand</font></a></a></li>
	";
	if(mysqli_num_rows($run_query) > 0){
		while($row = mysqli_fetch_array($run_query)){
			$bid = $row["brand_id"];
			...
			echo "
					<li><a href='#' class='selectBrand' bid='$bid'><font size='3.5px' color='#13004d'>$brand_name</font></a></li>
