...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 15, 2017 at 09:00 AM
...
INSERT INTO `tbl_employee` (`points`, `name`, `compart`, `winners`, `rank`) VALUES
(123, 'I.B.Patel', 'rakhi', 'none', 2),
(124, 'Mitha Nagar School', '0', '', 1),
(132, 'Santa Cruz BMC School', '0', '', 9),
(91, 'U. P. M. S Municipal', '0', '', 10),
(56, 'Mumbadevi  School', '0', '', 8),
(23, 'Gawaliya G. S. Tarapor', '0', '', 3),
(2, 'Vadgadi Municipal E. P. School ', '0', '', 5),
(7, 'Pahadi High School ', '0', '', 7),
(45, 'Rajda Municipal School', '0', 'none', 6);
...
--
ALTER TABLE `tbl_employee`
  MODIFY `points` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=133;
